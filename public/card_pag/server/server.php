...
MercadoPagoConfig::setAccessToken(getenv("APP_USR-3744454654525700-022519-337841e02d0b4d202c42227963e7287c-1353462493"));
...
$app->get('/', function (Request $request, Response $response, $args) {
    ...
    $response->getBody()->write($twig->render('index.html', ['public_key' => getenv("TEST-11673c88-d88c-43da-b0e8-e884b64b5e62")]));
    return $response;
});
